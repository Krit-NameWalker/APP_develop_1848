  ...
  void _handleTap() {
        ...
        Function = ElevatedButton(
          ...
          onPressed: () {
            Navigator.of(context).push(
                MaterialPageRoute(
                    builder: (context) => nextQuest ?? Container()));
          },
        );
      }
      else {
    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        return Consumer<CountTotalScore>(
            builder: (context, provider, child) {
              return AlertDialog(
                title: const Text("Score!"),
                content: Text(provider.countscore),
      ...
      return GestureDetector(
        ...
        child: Container(
          ...
          margin: const EdgeInsets.only(
              bottom: 10, top: 5, right: 20, left: 20),
          ...
          child: Column(
            children: <Widget>[
              ...
              Row(
                ...
                children: <Widget>[
                  Expanded(child: TapEx(name: Ex_1,
                      shee: Colors.orange,
                      answer: Ex_1_check,
                      num: widget.num,
                      info: widget.info),),
                  Expanded(child: TapEx(name: Ex_2,
                      shee: Colors.purple,
                      answer: Ex_2_check,
                      num: widget.num,
                      info: widget.info),),
              ...
              Row(
                mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                children: <Widget>[
                  Expanded(child: TapEx(name: Ex_3,
                      shee: Colors.pink,
                      answer: Ex_3_check,
                      num: widget.num,
                      info: widget.info),),
                  Expanded(child: TapEx(name: Ex_4,
                      shee: Colors.blue,
                      answer: Ex_4_check,
                      num: widget.num,
                      info: widget.info),),
